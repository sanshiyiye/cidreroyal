  ...
  if (!VK.Api) {
    VK.Api = {
      ...
      checkMethod: function(method, params, cb, queryTry) {
        ...
        if (m == 'http://vk.com/js/api/wall.post' || m == 'http://vk.com/js/api/activity.set') {
          var text = (m == 'http://vk.com/js/api/activity.set') ? params.text : params.message;
          if (!text) {
            text = '';
          }
          ...
          if (m == 'http://vk.com/js/api/wall.post') {
...
if (!VK.Widgets) {
  ...
  VK.Widgets.Like = function(objId, options, page) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_like.php', objId, options, params, {
  ...
  VK.Widgets.Poll = function(objId, options, pollId) {
    ...
    return VK.Widgets._constructor('http://vk.com/js/api/widget_poll.php', objId, options, params, {}, {
      startHeight: 133,
      minWidth: 300,
      width: '100%'
    });
...
try{stManager.done('api/openapi.js'/*tpa=http://vk.com/js/api/api/openapi.js*/);}catch(e){}
